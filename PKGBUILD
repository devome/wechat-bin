...
source=("${_pkgname}-LICENSE-zh_CN.html::https://weixin.qq.com/agreement?lang=zh_CN"
        "${_pkgname}-LICENSE-zh_HK.html::https://weixin.qq.com/agreement?lang=zh_HK"
        "${_pkgname}-LICENSE-zh_TW.html::https://weixin.qq.com/agreement?lang=zh_TW"
        "${_pkgname}-LICENSE-en.html::https://www.wechat.com/mobile/en/service_terms.html")
...
package() {
    depends=(at-spi2-core jack libcups libpulse libsm libxcomposite libxdamage libxkbcommon libxrandr mesa nss pango xcb-util-keysyms)
    mv {opt,usr} "${pkgdir}"
